...
#define IRoutingEngineComm_TestPOP3Auth(This,HostName,nPort,IsAPOP,UserName,Password,TimeoutSecs,pError)	\
    (This)->lpVtbl -> TestPOP3Auth(This,HostName,nPort,IsAPOP,UserName,Password,TimeoutSecs,pError)

#define IRoutingEngineComm_TestSMTPAuth(This,HostName,nPort,UserName,Password,TimeoutSecs,pError)	\
    (This)->lpVtbl -> TestSMTPAuth(This,HostName,nPort,UserName,Password,TimeoutSecs,pError)
